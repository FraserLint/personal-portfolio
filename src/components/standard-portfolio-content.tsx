...
const qualifications = [
    ...
    { id: 5, name: "GCSE English Literature", grade: "6" },
    { id: 6, name: "GCSE Photography", grade: "6" },
    { id: 7, name: "GCSE Statistics", grade: "5" },
    { id: 8, name: "GCSE History", grade: "5" },
    { id: 9, name: "GCSE Combined Science", grade: "6-6" },
]
